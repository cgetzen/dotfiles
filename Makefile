...
brew:
	(crontab -l ; echo "0 12 * * 1-5 $(CUR_DIR)/brew_manager.sh &> /tmp/brew.log && /usr/local/bin/terminal-notifier -title \"Updated brew\" -message \"/tmp/brew.log\"") | sort - | uniq - | crontab -
